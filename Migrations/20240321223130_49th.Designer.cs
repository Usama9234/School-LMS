...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.ClassWithStudentCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotlaIncome")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("ClassWithStudentCounts");
                });
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.Expenditures", b =>
                {
                    ...
                    b.Property<string>("ExpenditureTitle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.Parent", b =>
                {
                    b.Property<int>("ParentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ParentAdress")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("School_Management_System.Models.Teacher.Marks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.Classes", b =>
                {
                    ...
                    b.HasOne("School_Management_System.Models.Admin.Parent", null)
                        .WithMany("ClassesList")
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.Parent", b =>
                {
                    ...
                    b.HasOne("School_Management_System.Models.Admin.StudentDetails", "Students")
                        .WithMany()
