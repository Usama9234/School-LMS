...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssignedSubjectsTeacherDetails", b =>
                {
                    b.Property<int>("AssignedSubjectsAssignedSubjectId")
                        .HasColumnType("int");

                    b.Property<int>("TeachersListTeacherId")
                        .HasColumnType("int");

                    b.HasKey("AssignedSubjectsAssignedSubjectId", "TeachersListTeacherId");

                    b.HasIndex("TeachersListTeacherId");

                    b.ToTable("AssignedSubjectsTeacherDetails");
                });
            ...
            modelBuilder.Entity("AssignedSubjectsTeacherDetails", b =>
                {
                    ...
                    b.HasOne("School_Management_System.Models.Admin.TeacherDetails", null)
                        .WithMany()
                        .HasForeignKey("TeachersListTeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("School_Management_System.Models.Admin.StudentDetails", b =>
                {
                    ...
                    b.HasOne("School_Management_System.Models.Teacher.StudentAttendance", null)
